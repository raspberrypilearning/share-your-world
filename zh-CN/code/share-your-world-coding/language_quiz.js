...
function scratch(){
  ...
  languageText.innerText = "Scratch 是一个基于积木块的编程环境 \n \
...
function python(){
  ...
  languageText.innerText = "Python 是一种基于文本的编程语言。 \n \
...
function unity(){
  ...
  languageText.innerText = "C# 是一种更高级的基于文本的编程语言。 \n \
